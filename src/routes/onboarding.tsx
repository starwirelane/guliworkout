...
export default function Onboarding() {
  ...
  const [form, setForm] = useState({
    ...
    fitness_level: "beginner", equipment: "bodyweight only",
    goal: "lose_weight", workout_time: "17:00",
  });
    ...
    },
    {
      ...
      body: (
        <div className="space-y-3">
          <p className="text-sm text-foreground/60">We'll remind you and highlight your main session at this time each day.</p>
          <div className="grid gap-3">
            {TIME_SLOTS.map((t) => (
