...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Twoweek — Your free 14-day AI workout plan" },
      { name: "description", content: "A free, personalized 14-day workout plan generated for your body, your goal, your equipment. No payments, no ads, ever." },
      { property: "og:title", content: "Twoweek — Your free 14-day AI workout plan" },
      { property: "og:description", content: "A free, personalized 14-day workout plan. No payments, no ads, ever." },
    ],
  }),
  component: Landing,
});
      ...
      <section className="relative z-10 mx-auto grid max-w-6xl gap-12 px-6 py-16 md:grid-cols-2 md:py-24">
        ...
        <div className="relative flex items-center justify-center">
          <div className="floaty">
            <img src={heroImg} alt="Storybook illustration of a person stretching" className="w-full max-w-md" />
          </div>
        </div>
      </section>
